...
public class MainController {
    ...
    public void initialize() {
        ...
        departmentFilter.setItems(FXCollections.observableArrayList(
                "All Departments", "IT", "HR", "Finance", "Marketing", "Operations", "Engineering"));
    ...
    @FXML
    private void handleDepartmentFilter(ActionEvent event) throws InvalidDepartmentException {
    ...
    @FXML
    private void handleSearch(ActionEvent event) throws InvalidNameException {
